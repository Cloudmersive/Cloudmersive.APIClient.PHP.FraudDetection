...
(Get-Content ./README.md).replace('This PHP package is automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project:', '[Cloudmersive Fraud Detection API](https://cloudmersive.com/ai-fraud-detection-api) provides advanced AI fraud detection.') | Set-Content ./README.md
